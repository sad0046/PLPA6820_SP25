...
setwd("C:/Users/pred9/OneDrive/Desktop/AU_PhD/Auburn Stuff/Lithasia/2025_DuckRiver_PopGen/Duttoniana/")
...
data <- read.genepop(file="Duttoniana_min_max_1pop_Multi.snps.gen")
...
gentsubset <- data[i=c(gent$Names)]
...
data <- read.genepop(file="Lithasia_Duck_R80_NBA_Multi_NoOut.snps.gen")
